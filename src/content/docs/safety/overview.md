...
The safety design described here sits underneath the regulatory and privacy controls described elsewhere in the docs. For the rule context (Consumer Duty, CONC, PRIN, SMCR, FCA AI strategy) see the [regulatory section](/regulatory/overview); for the privacy and data-protection layer (UK GDPR as amended by DUAA, DPIA, retention, sub-processors, PECR) see the [privacy section](/privacy/overview).
