...
Anthropic is a US company and processes API traffic through US-based infrastructure. Sending UK personal data to a US sub-processor is a "restricted transfer" under UK GDPR Chapter V and requires an appropriate safeguard. The [Data (Use and Access) Act 2025](https://www.legislation.gov.uk/ukpga/2025/18/contents/enacted) made limited amendments to the international-transfer regime but did not displace the core obligation: a controller must rely on adequacy, an Article 46 safeguard (such as the IDTA), or a derogation. The ICO's [international transfers](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/international-transfers/) guidance sets out the available routes:
