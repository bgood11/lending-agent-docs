...
- **Right not to be subject to a solely automated decision (Article 22)**: this is the live wire for any agentic credit journey. The recommended posture is that the agent does not make a final lending decision: it brokers the application to a lender, who applies their own underwriting. Where automated decisioning is engaged, the customer must be told and given a route to human review. The ICO's draft [automated decision-making guidance](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/automated-decision-making-and-profiling/) reflects amendments introduced by the Data (Use and Access) Act 2025 and should be tracked.
